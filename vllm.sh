...
CUDA_VISIBLE_DEVICES=0 vllm serve /mnt/chenbang/models/gemma-4-E4B-it --served-model-name google/gemma-4-E4B-it --port 9999 -tp 1

CUDA_VISIBLE_DEVICES=1 vllm serve /mnt/chenbang/models/gemma-4-E4B-it --served-model-name google/gemma-4-E4B-it --port 10000 -tp 1

CUDA_VISIBLE_DEVICES=2 vllm serve /mnt/chenbang/models/gemma-4-E4B-it --served-model-name google/gemma-4-E4B-it --port 10001 -tp 1

CUDA_VISIBLE_DEVICES=0,1,2,3 vllm serve /mnt/chenbang/models/gemma-4-31B-it --served-model-name google/gemma-4-31B-it --port 9999 -tp 4 --max-num-seqs 32 --max-model-len 131072

CUDA_VISIBLE_DEVICES=2 vllm serve /mnt/chenbang/models/Qwen3-8B --served-model-name Qwen/Qwen3-8B --port 9999 -tp 1
...
CUDA_VISIBLE_DEVICES=2 vllm serve /mnt/chenbang/models/Qwen2.5-Coder-7B-Instruct --served-model-name Qwen/Qwen2.5-Coder-7B-Instruct --port 9999 -tp 1 --max-model-len 131072 --hf-overrides '{"rope_scaling": {"rope_type": "yarn", "factor": 4.0, "original_max_position_embeddings": 32768}}'
