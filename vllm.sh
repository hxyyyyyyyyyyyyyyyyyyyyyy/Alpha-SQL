...
CUDA_VISIBLE_DEVICES=0,1,2,3 vllm serve /mnt/chenbang/models/Qwen2.5-Coder-7B-Instruct --served-model-name Qwen/Qwen2.5-Coder-7B-Instruct --port 9999 -tp 4 --max-model-len 131072 --gpu-memory-utilization 0.8 --max-num-seqs 64 --hf-overrides '{"rope_scaling": {"rope_type": "yarn", "factor": 4.0, "original_max_position_embeddings": 32768}}'
