...
CUDA_VISIBLE_DEVICES=0,1 vllm serve /mnt/chenbang/models/Qwen2.5-Coder-7B-Instruct --served-model-name Qwen/Qwen2.5-Coder-7B-Instruct --port 9999 -tp 2

CUDA_VISIBLE_DEVICES=2,3 vllm serve /mnt/chenbang/models/DeepSeek-Coder-V2-Lite-Instruct --served-model-name deepseek/DeepSeek-Coder-V2-Lite-Instruct --port 10000 -tp 2
