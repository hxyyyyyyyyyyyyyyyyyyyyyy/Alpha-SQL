...
bash script/llm_guided_bird.sh > log/llm_guided_bird_eps0.2_2.log 2>&1

bash script/llm_nodescore_bird.sh > log/llm_nodescore_bird_eps0.2_2.log 2>&1

bash script/llm_genetic_bird_dev_7B.sh > log/llm_genetic_bird_dev_7B.log 2>&1

bash tools/sql_selection.sh results/llm_guide24_eps0.2
